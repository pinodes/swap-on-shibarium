    ...
    <>
      ...
      />
        <div style={{textAlign: 'center'}}>
          <img src={MainLogo} alt="logomain" style={{ opacity: 0.9}} width={300} />
          {/* <span style={{ opacity: 0.7, fontSize: 13 }}>v3</span> */}
        </div>
      <AppBody>
              ...
              {swapIsUnsupported ? (
                ...
                <AutoRow style={{ flexWrap: 'nowrap', width: '100%' }}>
                  <AutoColumn style={{ width: '100%' }} gap="12px">
                    ...
                    >
                      <Text fontSize={16} fontWeight={500} style={{ fontWeight: "bold" }}>
                        {priceImpactTooHigh ? (
                ...
                >
                  <Text fontSize={20} fontWeight={500} style={{ fontWeight: "bold" }}>
                    {swapInputError ? (
                      swapInputError
